...
export default function StatsCards() {
  ...
  return (
    <div className="flex gap-5">
      <div className="flex flex-col flex-1 border border-gray-200 rounded-lg p-2 lg:p-4 lg:space-y-1.5">
        ...
        <span className="text-md lg:text-2xl font-bold">{`$ ${stats.totalSales.toLocaleString()}`}</span>
      ...
      <div className="flex flex-col flex-1 border border-gray-200 rounded-lg p-2 lg:p-4 lg:space-y-1.5">
        <div className="flex gap-2 lg:gap-4 items-center px-2">
          ...
          <div className="flex gap-1">
            ...
            <span className="text-[10px] font-bold text-rose-400">-10.82%</span>
          </div>
        </div>
        <span className="text-slate-400 text-[10px] lg:text-xs font-semibold mt-4">
          ONLINE SALES
        </span>
        <span className="text-md lg:text-2xl  font-bold">{`$ ${stats.online.toLocaleString()}`}</span>
        <span className="text-slate-400 text-[10px] lg:text-xs">{`compare to ($1,000 last month)`}</span>
      </div>
      <div className="flex flex-col flex-1 border border-gray-200 rounded-lg p-2 lg:p-4 lg:space-y-1.5">
        <div className="flex gap-2 lg:gap-4 items-center px-2">
        ...
        <span className="text-md lg:text-2xl  font-bold">{`$ ${stats.returns.toLocaleString()}`}</span>
        <span className="text-slate-400 text-[10px] lg:text-xs">{`compare to ($1,000 last month)`}</span>
      </div>
    </div>
  );
